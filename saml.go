//
// [![](https://godoc.org/github.com/echocat/go-saml?status.svg)](http://godoc.org/github.com/echocat/go-saml)
//
...
//
// Public fields of _samlsp.Middleware_ have changed, so some usages may require adjustment. See [issue 231](https://github.com/echocat/go-saml/issues/231) for details.
//
...
// 	}
// 	keyPair.Leaf, err = x509.ParseCertificate(keyPair.CertificatePair[0])
// 	if err != nil {
// 		panic(err) // TODO handle error
// 	}
//
